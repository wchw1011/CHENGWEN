...
<body>
    ...
    <table  width="100%"  border="0"  bgcolor="#FFD39B">
    	<tr>
    		<td align="right">
				共<s:property value='articlePager.rowCount'/>条记录&nbsp;&nbsp;当前第<s:property value='articlePager.pageNo'/>页
				<a class="page_link" href="article!enterOriginalPage?pageNo=<s:property value='articlePager.firstPageNo'/>&pageSize=<s:property value='pageSize' />">首页</a>
				<a class="page_link" href="article!enterOriginalPage?pageNo=<s:property value='articlePager.prePageNo'/>&pageSize=<s:property value='pageSize'/>">前一页</a>
				<a class="page_link" href="article!enterOriginalPage?pageNo=<s:property value='articlePager.nextPageNo'/>&pageSize=<s:property value='pageSize'/>">下一页</a>
				<a class="page_link" href="article!enterOriginalPage?pageNo=<s:property value='articlePager.lastPageNo'/>&pageSize=<s:property value='pageSize'/>">尾页</a>
			</td>
			<!-- 
			<td align="right" >
				<input type="hidden" name="pageSize" id="pageSize"  value=<s:property value='articlePager.pageSize'/>></input>
				<input type="text"  id="forwardPageNo" name="forwardPageNo"  value="<s:property value='articlePager.pageNo'/>" size="1" />
				<input type="button"  value="跳转" onclick="PageChange();" />
			</td>-->
